...
<a name='L41'></a><a href='#L41'>41</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">15x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as debug from 'debug';
    ...
    public static configure() {
        try {
            ...
            if (CONFIG_FILE &amp;&amp; fs.existsSync(CONFIG_FILE)) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (config.serviceFactory) {
