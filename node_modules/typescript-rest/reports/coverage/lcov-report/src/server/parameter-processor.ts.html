...
<head>
    <title>Code coverage report for src/server/parameter-processor.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/server</a> parameter-processor.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    public processParameter(context: ServiceContext, property: ServiceProperty) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!processor) {
<span class="cstat-no" title="statement not covered" >            throw new Errors.BadRequestError('Invalid parameter type');</span>
        }
...
&nbsp;
        ...
        parameterMapper.set(ParamType.file, (context, property) =&gt; {
            ...
            // @ts-ignore
            const files: Array&lt;Express.Multer.File&gt; = context.request.files ? context.request.files[property.name] : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
            <span class="missing-if-branch" title="else path not taken" >E</span>if (files &amp;&amp; files.length &gt; 0) {
                return files[0];
            }
<span class="cstat-no" title="statement not covered" >            return null;</span>
        });
        parameterMapper.set(ParamType.files, <span class="fstat-no" title="function not covered" >(c</span>ontext, property) =&gt; {
<span class="cstat-no" title="statement not covered" >            this.debugger.runtime('Processing files parameter');</span>
            // @ts-ignore
<span class="cstat-no" title="statement not covered" >            return context.request.files[property.name];</span>
        });
