...
<head>
    <title>Code coverage report for src/server/server-container.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/server</a> server-container.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">87.74% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>229/261</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>98/130</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">87.55% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>225/257</span>
            </div>
...
<a name='L482'></a><a href='#L482'>482</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    public buildServices(types?: Array&lt;Function&gt;) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.authenticator) {
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (parentClassData.languages) {
<span class="cstat-no" title="statement not covered" >                classData.languages = _.union(classData.languages, parentClassData.languages);</span>
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (parentClassData.accepts) {
<span class="cstat-no" title="statement not covered" >                classData.accepts = _.union(classData.accepts, parentClassData.accepts);</span>
            }
        }
...
&nbsp;
        ...
        switch (serviceMethod.httpMethod) {
            ...
            case HttpMethod.PUT:
                ...
                break;
<span class="branch-3 cbranch-no" title="branch not covered" >            case HttpMethod.DELETE:</span>
<span class="cstat-no" title="statement not covered" >                this.router.delete.apply(this.router, args);</span>
...
&nbsp;
    private resolveAllPaths() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.pathsResolved) {
<span class="cstat-no" title="statement not covered" >            this.debugger.build('Building the server list of paths');</span>
<span class="cstat-no" title="statement not covered" >            this.paths.clear();</span>
<span class="cstat-no" title="statement not covered" >            this.serverClasses.forEach(<span class="fstat-no" title="function not covered" >classData </span>=&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >                        this.resolveProperties(classData, method);</span>
                    }
                });
            });
<span class="cstat-no" title="statement not covered" >            this.pathsResolved = true;</span>
        }
    }
&nbsp;
...
&nbsp;
    private getUploader(): multer.Multer {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.upload) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.fileDest) {
<span class="cstat-no" title="statement not covered" >                options.dest = this.fileDest;</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.fileFilter) {
<span class="cstat-no" title="statement not covered" >                options.fileFilter = this.fileFilter;</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.fileLimits) {
<span class="cstat-no" title="statement not covered" >                options.limits = this.fileLimits;</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (options.dest) {
<span class="cstat-no" title="statement not covered" >                this.debugger.build('Creating a file Uploader with options: %o.', options);</span>
...
&nbsp;
    private getAuthenticator(authenticatorName: string) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.authenticator.has(authenticatorName)) {
<span class="cstat-no" title="statement not covered" >            throw new Error(`Invalid authenticator name ${authenticatorName}`);</span>
        }
...
&nbsp;
    private buildAuthMiddleware(authenticator: ServiceAuthenticator, roles: Array&lt;string&gt;): express.RequestHandler {
        return (req: Request, res: Response, next: NextFunction) =&gt; {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.debugger.runtime.enabled) {
<span class="cstat-no" title="statement not covered" >                this.debugger.runtime('Validating authentication roles: &lt;%j&gt;.', requestRoles);</span>
            }
...
&nbsp;
    private buildFormParserMiddleware(bodyParserOptions: any) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!bodyParserOptions) {
...
&nbsp;
    private buildRawBodyParserMiddleware(bodyParserOptions: any) {
        let middleware: express.RequestHandler;
        this.debugger.build('Creating raw body parser with options %j.', bodyParserOptions || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (bodyParserOptions) {
            middleware = bodyParser.raw(bodyParserOptions);
        }
        else {
<span class="cstat-no" title="statement not covered" >            middleware = bodyParser.raw();</span>
        }
        return middleware;
    }
&nbsp;
    private buildCookieParserMiddleware() {
        const args = [];
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.cookiesSecret) {
<span class="cstat-no" title="statement not covered" >            args.push(this.cookiesSecret);</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.cookiesDecoder) {
<span class="cstat-no" title="statement not covered" >            args.push({ decode: this.cookiesDecoder });</span>
        }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu Jun 10 2021 22:06:07 GMT+0000 (Coordinated Universal Time)
            </div>
        </div>
