...
<head>
    <title>Code coverage report for src/server/server.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/server</a> server.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">95% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>95/100</span>
            </div>
...
export class Server {
    ...
    public static buildServices(router: express.Router, ...types: Array&lt;any&gt;) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!Server.locked) {
...
<span class="cstat-no" title="statement not covered" >                serverDebugger('Error loading services for pattern: %j. Error: %o', patterns, e);</span>
<span class="cstat-no" title="statement not covered" >                serverDebugger('ImportedTypes: %o', importedTypes);</span>
...
&nbsp;
     ...
     */
    public <span class="fstat-no" title="function not covered" >static </span>server() {
<span class="cstat-no" title="statement not covered" >        return ServerContainer.get().router;</span>
    }
&nbsp;
    /**
    ...
    public static registerServiceFactory(serviceFactory: ServiceFactory | string) {
        if (!Server.locked) {
            ...
            if (typeof serviceFactory === 'string') {
                ...
                factory = mod.default ? mod.default : <span class="branch-1 cbranch-no" title="branch not covered" >mod;</span>
            } else {
...
&nbsp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (options.schemes) {
...
&nbsp;
    private static loadSwaggerDocument(options: SwaggerOptions) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.endsWith(options.filePath, '.yml') || _.endsWith(options.filePath, '.yaml')) {
            swaggerDocument = YAML.load(options.filePath);
        }
        else {
<span class="cstat-no" title="statement not covered" >            swaggerDocument = fs.readJSONSync(options.filePath);</span>
        }
...
&nbsp;
    private static getOptions(options: SwaggerOptions) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.startsWith(options.filePath, '.')) {
