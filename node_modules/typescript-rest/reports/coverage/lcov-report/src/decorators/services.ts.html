...
<head>
    <title>Code coverage report for src/decorators/services.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/decorators</a> services.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    public withProperty(property: string, value: any, required: boolean = false) {
        this.properties.push({
            checkRequired: () =&gt; required &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!value,</span>
            process: (target: any) =&gt; {
...
class ProcessorServiceDecorator extends ServiceDecorator {
    public withArrayProperty(property: string, value: any, required: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
        this.properties.push({
